...
def calculates_results_stats(results_dic):
    ...
    # this function 
    # Creating an empty dictionary for result_state_dic
    results_stats_dic = dict()
    
    # Setting all encounters to inital values of zero so that they can 
    ...
    # Run throught the results dictionary
    for key in results_dic:
        # Labeling the Exact matches
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1
        
       
        # Labeling the dog and label matches
    ...
    # calculating number of not-a-dog images using image& dog images counts
    ...
    # Caluclate % of correct breed of dog
    results_stats_dic ['pct_correct_breed'] =   results_stats_dic['n_correct_breed'] / results_stats_dic['n_dogs_img'] * 100.0

    # Calculate the % of not-a-dog images
    # use conditional statements for when no 'not a dog' images were submitted
